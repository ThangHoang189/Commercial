using Commercial.Core.ContributorAggregate.Events;
using Commercial.Core.ProjectAggregate.Specifications;
using Commercial.SharedKernel.Interfaces;
using MediatR;

namespace Commercial.Core.ProjectAggregate.Handlers;
